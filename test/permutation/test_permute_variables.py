...
class TestPermuteVariables(unittest.TestCase):
  ...
  def test_permutation(self):
    filenames = [
      'test/permutation/outputs/output_0.py',
      'test/permutation/outputs/output_1.py',
      'test/permutation/outputs/output_2.py',
      'test/permutation/outputs/output_3.py',
      'test/permutation/outputs/output_4.py',
      'test/permutation/outputs/output_5.py',
      'test/permutation/outputs/output_6.py',
    ]
